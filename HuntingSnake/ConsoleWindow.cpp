...
void LoadConsole()
{
    ...
    //system("pause");
    Point obs[100000];
    Point const_obs[100000];
    int obs_nums = 0;
    int const_obs_nums = 0;
    bool up = true;
    int SC = 0;
    int LE = 1;
    //play_match2(1, 9, 45, 160, obs, obs_nums, SC, LE);
    //play_match3(1, 9, 45, 160, obs, obs_nums, SC, LE);
    play_match4(1, 9, 45, 160, obs, obs_nums, up, const_obs, const_obs_nums, SC, LE);
